...
class Registersalt
{
    public function generateUniqueApiKey()
    {
...
if (isset($_POST["submit"])) {
    ...
    $age = $_POST["age"];
    $subscriptionId = $saltN->generateUniqueApiKey();
    ...
    if (mysqli_num_rows($duplicate) > 0) {
        ...
        $query->bind_param("isssssiisssssssss", $userID, $username, $firstname, $lastname, $email, $password, $isAdmin, $city, $state, $postalCode, $dateOfBirth, $gender, $country, $apikey, $salt, $age, $subscriptionId);
        $query->execute();
